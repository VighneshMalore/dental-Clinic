...
const Footer = () => {
  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center text-white p-4 mt-4 gap-6">
        ...
        <button
          ...
          className="text-[#4F7A96] cursor-pointer hover:underline"
        >
          Privacy Policy
        </button>
        <div className="text-[#4F7A96]">
          {" "}
          &copy; 2023 Sakthi Dental Clinic. All rights reserved.
        </div>
      </div>
    </>
  );
